...
<head>
    ...
    <title>漫画レビュー</title>
    <meta name="description" content="nani">
                                        ...
                                        <form action="{{ route('search.result') }}">
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <input type="text" name="query" class="form-control" placeholder='検索キーワード' onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search Keyword'">
                                    ...
                                    <div class="main-menu d-none d-lg-block col-xl-8 col-lg-8">
                                        <nav>
                                            <ul id="navigation" class="d-flex justify-content-end align-items-center">
                                                @if(Auth::user())
                                                    @if(Auth::user()->admin)
                                                        <li><a href="{{ URL::to('admin/home-page') }}">ようこそ管理者!!</a></li>
                                                    @else
                                                        <li><a href="{{ URL::to('users/' . Auth::user()->user_id) }}"> ようこそ{{Auth::user()->user_name}}!!</a></li>
                                                    @endif
                                                @endif
                                                <li class="active"><a href="{{ URL::to('/home-page') }}">ホーム</a></li>
                                                <li><a href="{{ URL::to('/posts') }}">投稿一覧</a></li>
                                                ...
                                                @if (!session('status') && auth()->user())
                                                    <li><a href="#">アカウント</a>
                                                        <ul class="submenu">
                                                            <li><a
                                                                    href="{{ URL::to('users/' . Auth::user()->user_id) }}">プロフィール</a></li>
                                                            @if (auth()->user()->admin)
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-5">
                            <div class="single-footer-caption mb-50">
                                <div class="footer-tittle">
                                    <h4>私たちのチーム</h4>
                                    <ul>
                                        <li><a href="">グエン・バオ・ドゥック</a></li>
                                        <li><a href="">グエン・ティー・トゥイ・リン</a></li>
                                        <li><a href="">レー・ミン・クアン</a></li>
                                        <li><a href="">ドー・ティー・フォン</a></li>
                                        <li><a href="">ド・マイン・ハー</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                            <div class="single-footer-caption mb-50">
                                <div class="footer-tittle">
                                    <h4>連絡</h4>
                                    <ul>
                                        <li><a href="#">HEDSPI-D9、ハノイ工科大学</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
