        ...
        <div class="comment-form">
            ...
            <form class="form-contact comment_form" action="{{URL::to('/edit/'.$post->post_id)}}" id="commentForm" method="post" enctype="multipart/form-data" onsubmit="return validateData()">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <textarea class="form-control w-100" name="description" id="comment" cols="30" rows="1" placeholder="概要">{{$post->description}}</textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <!-- Nav tabs -->
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            {{-- <div class="tab-content"> --}}
                                <div role="tabpanel" class="tab-pane active" id="content">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="detail_content" id="post-content" cols="50" rows="30" placeholder="内容">{{$post->content}}</textarea>
                                    </div>
                                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="button button-contactForm btn_1 boxed-btn">保存</button>
                </div>
            </form>
        </div>
    </div>
