                            ...
                            @if(($current_user->user_id == $post->user->user_id) or ($current_user->admin))
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{URL::to('/edit/'.$post->post_id)}}">更新</a></li>
                                        @endif
            ...
            <div class="col-lg-9 posts-list">
                <div class="single-post">
                    ...
                    <div class="feature-img">
                        ...
                        <img class="img-fluid" src="{{asset('/user/img/default_post.jpg')}}" alt="">
                        @else
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control w-100" name="content" id="comment" cols="30" rows="9" placeholder="コメントを入力してください。"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="button button-contactForm btn_1 boxed-btn">コメントを送信</button>
                        </div>
                    </form>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget popular_post_widget">
                        <h3 class="widget_title" style="color: #2d2d2d;">新着レビュー</h3>
